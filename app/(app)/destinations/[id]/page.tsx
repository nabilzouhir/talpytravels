...
export default async function DestinationDetailPage({
  ...
  return (
    <div>
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mb-2 -mt-2 transition-colors"
      >
      ...
      {/* Hero */}
      <div className="-mx-4 h-32 bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center mb-4">
